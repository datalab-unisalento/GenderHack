...
document.querySelectorAll('.objective-card, .info-card, .output-card, .prize-category, .mention-card, .organizer-card, .category-detail-card, .rule-card, .contact-item, .stat-card, .resource-card').forEach(element => {
